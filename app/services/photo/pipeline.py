...
from app.services.photo.utils.image_io import validate_and_decode_image
from app.schemas_photo.responses import VerificationResult, CheckResult, PrimaryReason
from app.services.photo.person_checks import check_person_and_face
from app.services.photo.angle_detector import check_head_pose
from app.services.photo.quality_checks import check_blur, check_lighting, check_face_centering, check_explicit_content
from app.services.photo.occlusion_checks import check_eyes_open, check_eyewear, check_face_coverage, check_neutral_expression
from app.services.photo.background_checks import check_background_clutter
from app.services.photo.edit_detector import check_heavy_editing
from app.services.photo.utils.errors import VerificationError, ReasonCode
    ...
    try:
        ...
        if not passed:
            ...
            if checks["person_and_face"].passed or is_cartoon or position == "back":
                ...
                # 5.5 Uneven Lighting
                from app.services.photo.quality_checks import check_uneven_lighting
